import { addInventoryItem, adjustInventoryItem, listInventory, stockPartsOrderToInventory } from "../lib/inventory.js";
  ...
  try {
    if (req.method === "POST") {
      ...
      if (body.action === "stockPartsOrder") {
        await ensureSchema();
        const result = await stockPartsOrderToInventory({
          partsOrderId: body.partsOrderId,
