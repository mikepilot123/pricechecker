      ...
      <td data-label="Actions">
        <div class="parts-order-actions">
          ...
          <div class="parts-order-icon-actions">
            ...
            <button type="button" class="icon-btn ghost-btn" data-parts-edit="${esc(item.id)}" title="Edit part or status" aria-label="Edit part or status"><svg class="icon"><use href="#i-pencil"></use></svg></button>
