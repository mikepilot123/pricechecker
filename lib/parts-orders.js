...
export async function addPartsOrder(p) {
  ...
  await sql`
    INSERT INTO parts_orders (id, batch_id, shipment_name, vendor, part, quantity, unit_cost, status, ordered_at, arrived_at,
      customer_id, customer_name, customer_phone, ticket_id, source, source_document_url, notes)
    VALUES (${id}, ${batchId}, ${text(p.shipmentName)}, ${text(p.vendor)}, ${part}, ${quantity}, ${unitCost}, ${status}, ${orderedAt}, ${arrivedAt},
